...
#elif MB(CREALITY_V4)
  #include "stm32f1/pins_CREALITY_V4.h"         // STM32F1                                env:STM32F103RET6_creality env:STM32F103RET6_creality_maple env:STM32F103RE_voxelab_G32_maple env:STM32F103RE_voxelab_N32_maple
